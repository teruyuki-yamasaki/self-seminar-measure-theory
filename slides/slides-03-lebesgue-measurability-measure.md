...
したがって, この差 $\delta(A;I)$ が $0$ であるとき

$$
\mu^*(I)=\mu^*(I\cap A)+\mu^*(I\cap A^c)
$$

集合 $A$ は Lebesgue の意味で可測であると言える.
...
可算加法族のことを, **完全加法族**, **σ-加法族** と呼ぶこともある (ここで, σ は可算を意味するギリシャ文字).
...
$$
\mathcal{J}_N \subset \mathfrak{M}_{\mu^*} \subset 2^{\mathbb{R}^N}
$$
