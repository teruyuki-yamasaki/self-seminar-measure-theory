...
有界な区間 $I \in \mathfrak{I}_N$ に対して, その体積を表す集合函数
...
区間の有限個 $I_1, \ldots, I_n \in \mathfrak{I}_N$ の直和として表される集合
...
Jordan内側測度 $J_*$ および Jordan 外測度 $J^*$ は, Euclid空間 $\mathbb{R}^N$ 上の有界集合全体上で定義される集合函数である.
...
Jordan測度 $J$ は, Jordan 可測集合全体 $\mathcal{J}_N$ 上で定義される集合函数

$$
J: \mathcal{J}_N \to [0, \infty)
$$

であり, Jordan内側度 $J_*$ および Jordan 外測度 $J^*$ のJordan可測集合への制限である.
